...
function Footer() {
  return (
    <footer className="bg-gray-800 text-gray-400 py-4" >
      <div id="Footer"  className="container mx-auto flex items-center justify-between px-4">
        <div>
          <h3 className="text-lg font-semibold">BIANCO COSTAL HAUS</h3>
          <p className="text-sm">For futher enquiry, please visit our instagram or send us an email.</p>
        </div>
        <div>
          <h3 className="text-lg font-semibold">Visit our Instagram</h3>
      ...
      <ExternalLinkButton url="https://www.instagram.com/biancocoastalhaus/" buttonText="instagram" />
       ...
       <div>
          ...
          <p className="text-sm">biancocoastalhaus@gmail.com</p>
        </div>
      </div>
    </footer>
  );
